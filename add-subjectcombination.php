...
if($lastInsertId)
{
$msg="Aptitud agregada exitósamente";
}
else 
{
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Agregar métricas</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Métricas</li>
                                        <li class="active">Agregar métricas</li>
                                    </ul>
                                </div>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Proyecto</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Aptitud</label>
                                                        <div class="col-sm-10">
 <select name="subject" class="form-control" id="default" required="required">
<option value="">Selecciona la aptitud</option>
